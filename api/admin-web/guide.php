...
$mdPath = '';
foreach ([$root . '/docs/admin_guide.md', dirname($root) . '/docs/admin_guide.md'] as $candidate) {
...
tp_admin_web_layout_start('Техническое руководство', 'guide', $adminLogin !== '' ? $adminLogin : null);
crg_admin_guide_nav_links('dev');
