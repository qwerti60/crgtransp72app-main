...
$stmt = $conn->prepare("INSERT INTO orderst (iduser, vidt, city, startdate, enddate, cena, about, enddatez, img1, img2, img3, img4) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("isssssssssss", $iduser, $vidt, $city, $startdate, $enddate, $cena, $about, $enddatez, $img1, $img2, $img3, $img4);
