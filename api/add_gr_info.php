...
$stmt = $conn->prepare("INSERT INTO ordersg (iduser, city, startdate, enddate, cena, about, enddatez, img1, img2, img3, img4) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("issssssssss", $iduser, $city, $startdate, $enddate, $cena, $about, $enddatez, $img1, $img2, $img3, $img4);
