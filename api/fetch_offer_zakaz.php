<?php
/**
 * POST: iduserp, userId — чтение заявки заказчика из offer_dataf (см. add_offerzakaz.php).
 * Поле bd в ответе — значение из строки offer_dataf (для сохранения через add_offerzakaz.php).
 */
