...
class edit_ob_gp_usl extends StatefulWidget {
  final int id;
  const edit_ob_gp_usl({super.key, required this.id});
...
// Можно указать типы файлов, добавив параметры в pickImage
  ...
  void uploadData() async {
    var uri = Uri.parse('${Config.apiBase}/edit_gruz_info.php');
...
// Форматируем дату для отображения
  ...
  Future<List<Map<String, dynamic>>> fetchAds() async {
    ...
    final uri = Uri.parse(Config.baseUrl).replace(
      path: '${Config.apiPrefix}/edit_ob_grp.php',
      queryParameters: {
...
/*
      ...
      ..fields['iduser'] = userId.toString();
*/
          _dropdownValueTypePer = ad['typeper'];
          _dropdownValueZagr = ad['zagr'];
          _selectedVidkuzov = ad['vidk'];
          _selectedGP = ad['maxgruz'];
          _selectedCity = ad['city'];
          _selectedCity1 = ad['city1'];
