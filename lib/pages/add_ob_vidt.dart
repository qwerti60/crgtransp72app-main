...
class add_ob_vidt extends StatefulWidget {
  const add_ob_vidt({super.key});
  @override
...
class add_ob_vidtForm extends State<add_ob_vidt> {
...
// Генерируем новое имя файла для сжатого изображения
  ...
  Future<void> uploadData() async {
    ...
    try {
    var uri = Uri.parse('https://ivnovav.ru/api/add_ob_vidt.php');
