...
class rdit_ob_gp_usl_g extends StatefulWidget {
  ...
  const rdit_ob_gp_usl_g({super.key, required this.id});
...
class _add_ob_gpForm extends State<rdit_ob_gp_usl_g> {
              ...
              child: SizedBox(
                ...
                child: TextButton(
                    ...
                    onPressed: () async {
                      ...
                      if (about.isEmpty || cena.isEmpty || _cities.isEmpty) {
